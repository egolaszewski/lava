...
/**
 * Expression consisting of two elements: first, the head of the list. second, the rest of the list.
 * 
...
public class ListExpression implements Expression
{
     ...
     */
    private Expression functionCall(AtomicExpression head, ListExpression args, Environment env)
    {
     ...
     */
    private Expression lambdaCall(AtomicExpression head, ListExpression args, Environment env)
    {
