 ...
 * 
 * The context holds row/column information on the token being parsed as well as a buffer for building a token and a
 * queue of tokens that have been parsed.
 * 
...
public class TokenizerContext
{
    ...
    /**
     * Creates a new TokenizerContext. This context is completely clean and ready to use for a tokenizer run.
     */
    ...
    /**
     * Pops the token in the buffer and places it into the internal token queue. This has the side effect of resetting
     * the context state to 'READY'.
     */
