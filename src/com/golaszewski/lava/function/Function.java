...
public abstract class Function {
  ...
  /**
   * Returns true if the arguments for the function bound to this atom need to
   * be evaluated before being passed to the function or not.
   * 
   * This is generally important for functions like 'quote', where you may want
   * to operate on the passed argument data without necessarily evaluating it
    ...
    while (offset > 0) {
      ...
      if (current.rest() != null) {
        ...
        throw new IllegalArgumentException(String.format(
            "no arg exists at index %d for input %s.", index, argList));
      }
    }
