...
public class InterpreterTest
{
    ...
    public void cond()
    {
        ...
        makeAssertion("(cond ((eq (quote A) (quote B)) (quote A)) ((eq (quote A) (quote A)) (quote A)))", "A");
    }
    ...
    public void eq()
    {
        ...
        makeAssertion("(eq (cons (quote A) (quote B)) (cons (quote A) (quote B)))", "nil");
        makeAssertion("(eq (cons (quote A) (quote B)) (cons (quote B) (quote C)))", "nil");
    }
    ...
    public void recursiveFunction()
    {
        ...
        makeAssertion("(label last (lambda (list) (cond ((eq nil (cdr list)) (car list)) (#t (last (cdr list))))))",
                "#t");
        makeAssertion("(last (cons (quote a) (cons (quote b) (cons (quote c) nil))))", "c");
    }
